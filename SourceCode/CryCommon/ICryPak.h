...
struct ICryPak
{
	...
	inline const char* AdjustFileName(const char *szSourcePath, char szDestPath[g_nMaxPath], unsigned nFlags = 0)
	{
		return AdjustFileName(szSourcePath, szDestPath, nFlags, NULL);
	}
