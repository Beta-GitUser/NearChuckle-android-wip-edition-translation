...
- **Графический бэкенд Mesa Zink**: трансляция настольного OpenGL 2.1 в Vulkan для обеспечения максимальной совместимости и производительности на современных мобильных GPU.
...
- **Основные кнопки действий**:
  ...
  - Фонарик (`L`)
  - Бинокль (`B`)
  - Прибор ночного видения (`T`)
  - Бросок гранаты (`G`)
  - Смена оружия (Вперед / Назад)
